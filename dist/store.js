(function() {
  ...
  const INDEX = window.BMData.INDEX;
  const LS = {
  ...
  const Store = {
    ...
    async update(id, fields) {
      const updates = {};
      if (fields.title !== void 0) updates.title = fields.title;
      if (fields.url !== void 0) updates.url = fields.url;
